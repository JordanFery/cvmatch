...
export default async function CoverLetterPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      {/* Screen UI — hidden entirely when printing so only the letter below prints, regardless of which tab was active. */}
      ...
      {/* Print-only — always the letter, never the edit form. */}
