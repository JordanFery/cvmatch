...
export function LandingCta({ dict, isAuthenticated = false }: { dict: Dictionary; isAuthenticated?: boolean }) {
  return (
    <section className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
      ...
      <div className="mt-8">
        <ButtonLink href={isAuthenticated ? "/dashboard" : "/register"} size="lg">
